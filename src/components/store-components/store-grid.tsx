      ...
      <div className="max-w-7xl mx-auto md:px-5">
        <div className="grid md:grid-cols-2 md:gap-5 gap-0">
          ...
          <div className="flex flex-col text-white md:gap-2 gap-0">
            {/* 1 */}
            <div className="bg-[url('/images/store-grid-2.png')] bg-center bg-cover md:rounded-xl  p-8 flex-1 relative flex flex-col justify-center hover:shadow-lg transition-shadow cursor-pointer overflow-hidden">

               <div className="absolute inset-0 bg-black/40 z-10"></div>

            <div className='max-w-[308px] z-20'>

              <h3 className="text-xl md:text-[32px] font-bold  mb-2">Deal of the day</h3>

              <p className="hidden md:block text-sm md:text-[18px] z-20  mb-6">
            ...
            {/* 2 */}
            <div className="bg-[url('/images/store-grid-3.png')] md:rounded-xl p-8 flex-1 flex flex-col justify-center hover:shadow-lg transition-shadow cursor-pointer bg-cover bg-center relative overflow-hidden">

             <div className="absolute inset-0 text-white bg-black/40 z-10"></div>

              <div className='max-w-[308px] mx-auto text-left z-20'>

...
export const NewsCard = () => {
    ...
    return (
        <section 
            ref={sectionRef}
            className="w-full px-4 py-12 md:py-16 lg:py-20"
        >
                        ...
                        return (
                            ...
                            >
                                <div className="relative overflow-hidden">
                                    <div className={`relative ${isCenter ? 'aspect-[4/3]' : 'aspect-[4/3]'} w-full overflow-hidden bg-gray-100`}>
                                        <Image
                                            className="news-image object-cover transition-transform duration-500"
                                            fill
                                            src={item.img}
                                            alt={`News article ${i + 1}`}
                                            sizes={isCenter ? "(max-width: 768px) 100vw, 40vw" : "(max-width: 768px) 100vw, 30vw"}
                                        />
                                    </div>
                                ...
                                <div className={`p-6 ${isCenter ? 'lg:p-8' : 'lg:p-6'}`}>
                                    <p className={`news-text font-medium text-gray-800 leading-relaxed transition-colors duration-300 ${

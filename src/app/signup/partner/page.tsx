...
export default function PartnerSignUpPage() {
  ...
  const { mutate: signup, isPending } = usePartnerSignup();
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 sm:p-10">
            ...
            <div className="mb-8">
              ...
              <p className="text-gray-600">
                Share your expertise and reach our audience
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              {/* Service Type Select */}
              <div>
                <label htmlFor="typeOfService" className="block text-sm font-medium text-gray-700 mb-2">
                  Type of Service
                </label>
                <select
                  id="typeOfService"
